...
async function signup(req, res, next) {
  const enteredData = {
    ...
    sessionFlash.flashDataToSession(req, {
        errorMessage: 'Please check your input, email and confirm email should match, also pasword should be atleast 6 characters long, postal must be 6 characters long!',
        ...enteredData
      }, 
      function() {
        res.redirect("/signup");
	...
	try {
		const exisitsAlready = await user.existsAlready();
